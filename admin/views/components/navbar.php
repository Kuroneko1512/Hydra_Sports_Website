        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav" class="p-t-30">
                <li class="sidebar-item"> 
                    <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?= $route->getLocateAdmin('dashboard') ?>" aria-expanded="false">
                ...
                <!-- Reviews -->
                <li class="sidebar-item">
                    <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?= $route->getLocateAdmin('list-review') ?>" aria-expanded="false">
